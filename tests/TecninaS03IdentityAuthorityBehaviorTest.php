...
$deliveryFailure = $authority->issueEmailVerification(['intake_id'=>'00000000-0000-4000-8000-000000000001','email_candidate'=>'delivery@example.test','purpose'=>'ACCOUNT_CREATION','idempotency_key'=>'delivery-fail']);
