...
expectIntakePanel($controller !== false && $view !== false && $script !== false && $gateway !== false, 'Arquivos do painel ausentes.');
$panel = $view . "\n" . $script;
...
expectIntakePanel(strpos($panel, 'Pré-atendimentos') !== false, 'Aba de pré-atendimentos ausente.');
