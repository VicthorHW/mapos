...
CREATE TABLE IF NOT EXISTS `os` (
  ...
  `credencial_tipo` VARCHAR(20) NOT NULL DEFAULT 'nao_informada',
  `credencial_dados` TEXT NULL DEFAULT NULL,
  `credencial_grade` TINYINT UNSIGNED NULL DEFAULT NULL,
  `credencial_atualizada_em` DATETIME NULL DEFAULT NULL,
