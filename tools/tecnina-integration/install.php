...
$required = [
    ...
    'application/controllers/api/bot/Client_open_os.php',
    'application/controllers/api/bot/Client_profile.php',
    'application/controllers/api/bot/Client_registration.php',
    'application/controllers/api/bot/Clients.php',
    ...
    'application/models/Tecnina_bot_client_model.php',
