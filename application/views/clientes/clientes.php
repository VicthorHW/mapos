    ...
    <div class="widget-box">
        ...
        foreach ($results as $r) {
            ...
            if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vCliente')) {
                ...
                echo '<a href="' . html_escape(cliente_url('mine') . '?e=' . rawurlencode($r->email)) . '" target="new" style="margin-right: 1%" class="btn-nwe2" title="Área do cliente"><i class="bx bx-key bx-xs"></i></a>';
            }
