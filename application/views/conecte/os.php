...
if (!$this->session->userdata('cadastra_os')) { ?>
    <div class="span12" style="margin-left: 0">
        <div class="span3">
            <a href="<?php echo cliente_url('mine/adicionarOs'); ?>" class="button btn btn-success" style="max-width: 150px">
...
<?php
    ...
    foreach ($results as $r) {
        ...
        echo '<td><a href="' . cliente_url('mine/visualizarOs/' . $r->idOs) . '" class="btn-nwe" title="Visualizar e Imprimir"><i class="bx bx-show-alt"></i></a>
                                  <a href="' . cliente_url('mine/imprimirOs/' . $r->idOs) . '" class="btn-nwe3" title="Imprimir" target="_blank"><i class="bx bx-printer"></i></a>
                                  <a href="' . cliente_url('mine/detalhesOs/' . $r->idOs) . '" class="btn-nwe4" title="Ver mais detalhes"><i class="bx bx-detail"></i></a>
                                  </td>';
        echo '</tr>';
    } ?>
                    </tbody>
