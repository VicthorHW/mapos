(function ($) {
    ...
    function pickupSummary(data) {
        ...
        return '<div class="well well-small"><strong>Coleta confirmada pelo cliente</strong><br>' +
            ...
            '<br><strong>GPS opcional:</strong> ' + (data.gps_available ? 'Recebido' : 'Não informado') + '</div>';
    }
